    ...
    <div class="h-full md:float-right p-3 hidden md:block">
      <nav class="flex flex-col text-black dark:text-white gap-3 float-right xl:float-none" role="navigation">
        ...
        >
          <div class="inline-flex items-center xl:gap-4 py-3 xl:px-2 hover:bg-blue-400 hover:bg-opacity-10 hover:text-blue-400 rounded-full" :class="[isActive && 'text-blue-400']">
            <div class="fill-current">
              ...
              <div class="pr-4">
                <span class="font-bold text-xl hidden xl:block">Home</span>
              </div>
          </div>
        </router-link>
        <router-link
        ...
        >
          <div class="inline-flex items-center xl:gap-4 py-3 xl:px-2 hover:bg-blue-400 hover:bg-opacity-10 hover:text-blue-400 rounded-full" :class="[isActive && 'text-blue-400']">
            <div class="fill-current">
              ...
              <div class="pr-4">
                <span class="font-bold text-xl hidden xl:block">Notifications</span>
              </div>
          </div>
        </router-link>
        <router-link
        ...
        >
          <div class="inline-flex items-center xl:gap-4 py-3 xl:px-2 hover:bg-blue-400 hover:bg-opacity-10 hover:text-blue-400 rounded-full" :class="[isActive && 'text-blue-400']">
            <div class="fill-current">
              ...
              <div class="pr-4">
                <span class="font-bold text-xl hidden xl:block">Messages</span>
              </div>
          </div>
        </router-link>
        <router-link
        ...
        >
          <div class="inline-flex items-center xl:gap-4 py-3 xl:px-2 hover:bg-blue-400 hover:bg-opacity-10 hover:text-blue-400 rounded-full" :class="[isActive && 'text-blue-400']">
            <div class="fill-current">
                <svg class="h-7" viewBox="0 0 24 24" aria-hidden="true"><g><path d="M19.9 23.5c-.157 0-.312-.05-.442-.144L12 17.928l-7.458 5.43c-.228.164-.53.19-.782.06-.25-.127-.41-.385-.41-.667V5.6c0-1.24 1.01-2.25 2.25-2.25h12.798c1.24 0 2.25 1.01 2.25 2.25v17.15c0 .282-.158.54-.41.668-.106.055-.223.082-.34.082zM12 16.25c.155 0 .31.048.44.144l6.71 4.883V5.6c0-.412-.337-.75-.75-.75H5.6c-.413 0-.75.338-.75.75v15.677l6.71-4.883c.13-.096.285-.144.44-.144z"></path></g></svg>
              </div>
              <div class="pr-4">
                <span class="font-bold text-xl hidden xl:block">Bookmarks</span>
              </div>
          </div>
        </router-link>
        <router-link

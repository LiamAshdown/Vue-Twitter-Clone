<template>
  <div class="flex py-3 px-5">
    <div>
      <img alt="Liam Ashdown" class="rounded-full h-12 mr-4" src="https://abs.twimg.com/sticky/default_profile_images/default_profile_normal.png">
    </div>
    <div class="w-96">
      <div>
        <span class="text-gray-400 mr-1">Liam Ashdown</span>
        <span class="text-gray-500">@LiamAshdown1 - 40m</span>
      </div>
      <div class="flex justify-between">
        ...
        <div class="p-3 flex items-center rounded-full hover:bg-green-400 hover:bg-opacity-10">
